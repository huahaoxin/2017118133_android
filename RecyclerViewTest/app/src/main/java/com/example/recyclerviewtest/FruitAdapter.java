    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        holder.bt1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(view.getContext(), "You click Edit: " + fruit.getName(), Toast.LENGTH_SHORT).show();
        ...
        holder.bt2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                final int position = holder.getAdapterPosition();
                final Fruit fruit = mFruitList.get(position);
                Toast.makeText(v.getContext(), "You clicked delete： " + fruit.getName(), Toast.LENGTH_SHORT).show();
